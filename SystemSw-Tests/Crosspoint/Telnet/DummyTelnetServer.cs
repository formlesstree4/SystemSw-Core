...
{
    public sealed class DummyTelnetServer
    {
        ...
        /// by their socket.
        /// </summary>
        private Dictionary<Socket, DummyTelnetClient> clients;

        public delegate void ConnectionEventHandler(DummyTelnetClient c);
        /// <summary>
        ...
        public delegate void MessageReceivedEventHandler(DummyTelnetClient c, string message);
        /// <summary>
        ...
        public DummyTelnetServer(IPAddress ip, int dataSize = 1024)
        {
            this.ip = ip;
            this.dataSize = dataSize;
            this.data = new byte[dataSize];
            this.clients = new Dictionary<Socket, DummyTelnetClient>();
        ...
        public void clearClientScreen(DummyTelnetClient c)
        {
        ...
        public void sendMessageToClient(DummyTelnetClient c, string message)
        {
        ...
        private DummyTelnetClient getClientBySocket(Socket clientSocket)
        {
            DummyTelnetClient c;
        ...
        private Socket getSocketByClient(DummyTelnetClient client)
        {
            Socket s;
        ...
        public void kickClient(DummyTelnetClient client)
        {
        ...
        private void handleIncomingConnection(IAsyncResult result)
        {
            try
            {
                ...
                if (acceptIncomingConnections)
                {
                    ...
                    DummyTelnetClient client = new DummyTelnetClient(clientID, (IPEndPoint)newSocket.RemoteEndPoint);
        ...
        private void receiveData(IAsyncResult result)
        {
            ...
            {
                Socket clientSocket = (Socket)result.AsyncState;
                DummyTelnetClient client = getClientBySocket(clientSocket);
